...
export async function POST(req: Request) {
    ...
    const response = await openai.createCompletion({
        ...
        Question: tôi muốn viết một chương trình giống chatGPT và đang không biết làm thế nào để phần mềm có thể biết và hiển thị phần lập trình theo 1 khung khi được hỏi, bạn có thể giải thích giúp tôi
